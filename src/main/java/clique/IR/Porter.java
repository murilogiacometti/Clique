 ...
 *
 * comments: Compile it, import the Porter class into you program and create an
 *      instance. Then use the stripAffixes method of this method which takes a 
...
public class Porter {
    ...
    public String stripAffixes( String str ) {
        ...
        if (( newStr != "" ) && (newStr.length() > 2)) {
            ...
            newStr = stripPrefixes(newStr);

            if (newStr != "" ) 
                newStr = stripSuffixes(newStr);
    ...
    public static void main(String args[]) {
        ...
        System.out.println(porter.stripPrefixes(porter.stripAffixes(args[0])));
