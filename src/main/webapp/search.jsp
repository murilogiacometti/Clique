...
<head>
	...
	<script type="text/javascript" src="js/general-search.js"></script>
    ...
    <div id="col" class="box">
		...
		<div id="interest-search">
			<form action="/clique/search" method="get">
				...
				<input id="interest-submit" type="submit" value="Search"/>
		    </form>
			...
			<h2 class="search-title">Interests</h2>
			<div class="search" id="interest_search"><h3 class="search_interest">
			<%		
				ArrayList<PersonWord> interests = (ArrayList<Person>)request.getAttribute("interests");
				for(int i = 0; i < 18; i++) {%>
						<span>
						<a class="interest-link" href="/clique/people_interest?id=<%=interests.get(i).getId()%>">
