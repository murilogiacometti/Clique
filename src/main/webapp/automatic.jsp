...
<div id="main">
    ...
    <div id="col" class="box">
		...
		<%
			//ArrayList<Word> interests = (ArrayList) request.getAttribute("people");
			//word.getPeople().getScore();
			//if (people != null) 
			//	for(int i = 0; i < people.size(); i++) {
		%>
		<div id="tag-cloud">
			<!--<span class="interest-word" id="score%=/*getScore*/%">
					%=/*getName()*/%
					<input class="relevance-field" type="hidden" value="%= getRelevance %"/>
				</span> -->
